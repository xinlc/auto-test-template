...
class PageObject(object):
    ...
    def __init__(self, webdriver, root_uri=None, default_timeout=WAIT_TIMEOUT, default_poll_delay=POLL_DELAY):
        self.w = webdriver
...
class PageElement(object):
    ...
    def __init__(self, context=False, timeout=None, **kwargs):
        if not kwargs:
